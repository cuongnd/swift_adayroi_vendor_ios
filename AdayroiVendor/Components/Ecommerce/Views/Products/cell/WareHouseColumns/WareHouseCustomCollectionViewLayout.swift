...
import UIKit
@available(iOS 13.0, *) struct CellWidthHeightWareHouse {
    var width:[Int]
    var headHeight:Int
    var bodyHeight:Int
...
@available(iOS 13.0, *)
class WareHouseCustomCollectionViewLayout: UICollectionViewLayout {
...
// MARK: - Helpers
@available(iOS 13.0, *) extension WareHouseCustomCollectionViewLayout {
